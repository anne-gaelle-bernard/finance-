...
import { User, Mail, Calendar, TrendingUp, TrendingDown, PieChart, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              {isEditing ? (
                ...
                <>
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">{currentUser?.name}</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="glass-card rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold text-gray-600">Net Savings</h3>
                    ...
                    tooltip: {
                      callbacks: {
                        label: (context) => {
                          ...
                          return `Net Savings: $${value.toFixed(2)}`;
                        }
                      }
                    }
                  },
        ...
        <div className="glass-card rounded-xl shadow-lg p-6 mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-gray-600 mt-1">Income Entries</p>
            </div>
            <div className="text-center p-4 bg-red-50 rounded-lg">
              <p className="text-3xl font-bold text-red-600">
                {transactions.filter(t => t.type === 'expense').length}
              </p>
              <p className="text-gray-600 mt-1">Expense Entries</p>
            </div>
          </div>
        </div>
      </div>
