...
import { TrendingUp, Home, DollarSign, PiggyBank, CreditCard, Calendar, BarChart3 } from 'lucide-react';

const FinanceSimulatorSection = () => {
...
export default FinanceSimulatorSection;
